...
Name:           wine
Version:        11.0
Release:        rc1^ec3%{dist}
Summary:        A compatibility layer for windows applications

License:        LGPL-2.1-or-later
URL:            https://www.winehq.org/
Source0:        https://dl.winehq.org/wine/source/11.0/wine-%{version}-rc1.tar.xz
Source10:       https://dl.winehq.org/wine/source/11.0/wine-%{version}-rc1.tar.xz.sign
...
Source900:      https://gitlab.winehq.org/wine/wine-staging/-/archive/v%{version}/wine-staging-%{version}-rc1.tar.gz
%if 0%{?fedora} == 42
...
# Remove branch protection flag that breaks wine on Apple M2 architecture (armv8.6-a)
