...
#endif
#ifdef _WIN64
    /* push $7; mov $100,%eax; xor %edx,%edx; divl (%rsp); add $8,%rsp; ret -> 14 */
    { "div mem", { 0x6a, 0x07, 0xb8, 0x64, 0, 0, 0, 0x31, 0xd2, 0xf7, 0x34, 0x24, 0x48, 0x83, 0xc4, 0x08, 0xc3 }, 17, 0, 0,
      0, 14 },
#else
    /* push $7; mov $100,%eax; xor %edx,%edx; divl (%esp); add $4,%esp; ret -> 14 */
    { "div mem", { 0x6a, 0x07, 0xb8, 0x64, 0, 0, 0, 0x31, 0xd2, 0xf7, 0x34, 0x24, 0x83, 0xc4, 0x04, 0xc3 }, 16, 0, 0,
      0, 14 },
#endif
